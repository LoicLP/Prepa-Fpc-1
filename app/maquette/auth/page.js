...
const MODULES = [
  ...
  { label: 'Produit en croix', bg: 'linear-gradient(145deg, #6ee7b7, #34d399)', ink: '#064e3b', accent: '#10b981', icon: (c) => <svg className="w-11 h-11" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 3h5v5"/><path d="M8 3H3v5"/><path d="M21 3 3 21"/><path d="m3 3 18 18"/></svg> },
