    ...
    <div className="min-h-screen bg-white text-[#0d0d0d] antialiased" style={{fontFamily: "'Inter', system-ui, -apple-system, sans-serif"}}>
      ...
      <nav className="hidden md:flex fixed left-1/2 top-6 -translate-x-1/2 z-50 h-[60px] w-[min(880px,calc(100vw-40px))] items-center gap-x-6 rounded-full bg-[hsla(0,0%,93%,0.72)] backdrop-blur-xl px-6 py-2">
        ...
        <div className="nav-dim flex items-center gap-x-1 mx-auto">
          ...
          <a href="/calculs-doses" className="px-3.5 py-2 whitespace-nowrap text-[0.95rem] font-bold text-[#0d0d0d]">Calculs de doses</a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr_1fr] gap-x-8 gap-y-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[15px] text-white/85">
                ...
                <li><a href="/calculs-doses" className="hover:text-white transition">Formules de calculs</a></li>
