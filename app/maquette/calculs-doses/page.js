  ...
  return (
    <>
      ...
      <section className="relative px-5 pt-8 pb-16 sm:pb-24">
        {/* Décorations */}
        <div aria-hidden="true" className="absolute top-40 -left-24 w-80 h-64 rounded-full blur-3xl pointer-events-none transition-colors duration-500" style={{background: `${theme.couleur}12`}}></div>
