        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
          ...
          {page === 'dashboard' && (
            <div>
              ...
              {(() => {
                const locked = trialDays === 0 && !isPremium
                const lockIcon = <svg className="w-8 h-8 text-slate-300" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                return (
              <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
                <a href={locked ? '#' : '/specifique'} onClick={locked ? (e) => e.preventDefault() : undefined} className={`bg-white p-5 rounded-2xl border-2 border-blue-600 shadow-sm hover:shadow-md transition group flex flex-col items-center text-center ${locked ? 'opacity-75' : ''}`}>
                  ...
                  {locked ? <div className="flex-1 flex items-center justify-center py-2">{lockIcon}</div> : <>
                ...
                <a href={locked ? '#' : '/maths'} onClick={locked ? (e) => e.preventDefault() : undefined} className={`bg-white p-5 rounded-2xl border-2 border-red-600 shadow-sm hover:shadow-md transition group flex flex-col items-center text-center relative ${locked ? 'opacity-75' : ''}`}>
                ...
                <a href={locked ? '#' : '/redaction'} onClick={locked ? (e) => e.preventDefault() : undefined} className={`bg-white p-5 rounded-2xl border-2 border-purple-600 shadow-sm hover:shadow-md transition group flex flex-col items-center text-center relative ${locked ? 'opacity-75' : ''}`}>
                ...
                <a href={locked ? '#' : '/examen'} onClick={locked ? (e) => e.preventDefault() : undefined} className={`bg-white p-5 rounded-2xl border-2 border-yellow-500 shadow-sm hover:shadow-md transition group flex flex-col items-center text-center relative ${locked ? 'opacity-75' : ''}`}>
                ...
                <a href={locked ? '#' : '/oral'} onClick={locked ? (e) => e.preventDefault() : undefined} className={`bg-white p-5 rounded-2xl border-2 border-emerald-600 shadow-sm hover:shadow-md transition group flex flex-col items-center text-center ${locked ? 'opacity-75' : ''}`}>
