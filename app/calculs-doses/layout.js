export const metadata = {
  ...
  keywords: [
    ...
    "concours FPC IFSI",
    "produit en croix infirmier",
    "débit gouttes par minute",
    "concentration pourcentage médicament",
    "conversions g mg µg",
    "exercices calculs doses",
    "fiches révision concours infirmier",
...
export default function CalculsDosesLayout({ children }) {
  return children
}
